...
let PersonalWakeupCard = class PersonalWakeupCard extends i {
    ...
    _formatNextFire(value) {
        ...
        try {
            ...
            if (this.hass && "formatDateTime" in this.hass) {
                return this.hass.formatDateTime(d);
            }
    ...
    render() {
      ...
      `;
        ...
        const canSnooze = Boolean(attrs.can_snooze) || stateObj.state === "triggered";
        ...
        <div class="grid">
          ...
          <div class="row">
            ...
            <ha-slider
              ...
              step="1"
              .value=${fadeMinutes}
              @input=${(e) => (this.shadowRoot.getElementById("fade_value").textContent =
            String(e.target.value) + " min")}
              @change=${(e) => this._updateConfig({
            fade_duration: Number(e.target.value) * 60
        })}
            ></ha-slider>
          ...
          <div class="row">
            ...
            <ha-slider
              ...
              step="0.05"
              .value=${volume}
              @input=${(e) => (this.shadowRoot.getElementById("volume_value").textContent =
          ...
          <div class="row">
            ...
            ? x `
                ...
                `
            : x `<span class="value">${playlist || "Default"}</span>`}
          </div>
        </div>
...
window.customCards.push({
    ...
    description: "Control a Personal Wakeup alarm entity (time, fade, volume, playlist, require_home)."
});
